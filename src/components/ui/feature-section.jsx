...
export function FeatureSection() {
   const features = [
  {
    ...
    skeleton: <img src="/1.jpeg" />,
    className: "md:col-span-4 row-span-1 col-span-6  border-b lg:border-r border-neutral-800",
  },
  {
    title: "Capture pictures with AI",
    description: "Capture stunning photos effortlessly using our advanced AI technology.",
    skeleton: <img src="/1.jpeg" />,
    className: "md:col-span-2 col-span-6 row-span-1 border-b border-neutral-800", // First half
  },
  {
    title: "Watch our AI on YouTube",
    description: "Whether it's you or Tyler Durden, you can get to know about our product on YouTube.",
    skeleton: <img src="/1.jpeg" />,
    className: "md:col-span-2 col-span-6 row-span-1 lg:border-r border-neutral-800", // Second half below the 2nd item
  },
  {
    title: "ss",
    description: "With our blazing-fast, state-of-the-art cloud services, you can deploy your model in seconds.",
    skeleton: <img src="/1.jpeg" />,
    className: "md:col-span-2 col-span-6 row-span-1 border-r ",
  },
  {
    title: "vv",
    description: "With our blazing-fast, state-of-the-art cloud services, you can deploy your model in seconds.",
  ...
  return (
    (<div className="relative z-20  mb-32 max-w-7xl mx-auto">
      <div className="px-8">
        <h4
      ...
      <div className="relative ">
        <div
          className="grid  grid-cols-6 m-12 xl:border rounded-md border-neutral-800"style={{ gridTemplateRows: "400px 500px" }}> 
...
const FeatureCard = ({
  ...
  return (
    (<div className={cn(`p-4 sm:p-8 relative overflow-hidden my-5`, className)}>
      {children}
    </div>)
  );
};
